...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='subscriber',
            field=models.ManyToManyField(blank=True, db_constraint=False, related_name='ProjectTrace_sub', to=settings.AUTH_USER_MODEL, verbose_name='参与者'),
        ),
        migrations.AddField(
            model_name='projecttrace',
            name='trace_status',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='trace', to='engineering.TraceStatus'),
        ),
        migrations.AddField(
            model_name='projecttrace',
            name='user',
        ...
        migrations.AddField(
            model_name='project',
            name='collect',
            field=models.ManyToManyField(blank=True, db_constraint=False, related_name='collect', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='project',
            name='diagnosisman',
        ...
        migrations.AddField(
            model_name='project',
            name='priority',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='project', to='engineering.ProjectPriority'),
        ),
        migrations.AddField(
            model_name='project',
            name='product',
