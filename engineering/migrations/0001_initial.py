    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('serial', models.CharField(blank=True, max_length=64, null=True, verbose_name='项目流水号')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.DateTimeField(auto_now_add=True)),
                ('update_time', models.DateTimeField(auto_now=True)),
                ('progress', models.SmallIntegerField(blank=True, null=True, verbose_name='进度百分比')),
                ('issue_status', models.CharField(blank=True, max_length=64, null=True, verbose_name='问题状态')),
                ('status', models.SmallIntegerField(blank=True, null=True, verbose_name='关联-(ProjectStatusTime) 日报')),
                ('content', models.TextField(verbose_name='内容')),
                ('outsourcer', models.SmallIntegerField(blank=True, null=True, verbose_name='关联-(Outsourcer) 日报')),
                ('worklog', models.SmallIntegerField(blank=True, null=True, verbose_name='关联-(WorkLog) 日报')),
                ('task', models.SmallIntegerField(blank=True, null=True, verbose_name='关联-(Task) 日报')),
